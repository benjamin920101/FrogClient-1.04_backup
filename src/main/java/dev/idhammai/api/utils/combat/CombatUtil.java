 ...
 */
package dev.idhammai.api.utils.combat;
...
implements Wrapper {
    ...
    public static List<PlayerEntity> getEnemies(double range) {
        ...
        for (AbstractClientPlayerEntity player : Frog.THREAD.getPlayers()) {
    ...
    public static void attack(Entity entity, boolean rotate) {
        if (entity != null) {
            ...
            if (rotate && AntiCheat.INSTANCE.attackRotate.getValue()) {
                Frog.ROTATION.lookAt(attackVec);
            }
    ...
    public static boolean isValid(Entity entity, double range) {
        PlayerEntity player;
        boolean invalid = entity == null || !entity.isAlive() || entity.equals((Object)CombatUtil.mc.player) || entity instanceof PlayerEntity && Frog.FRIEND.isFriend(player = (PlayerEntity)entity) || CombatUtil.mc.player.getPos().distanceTo(entity.getPos()) > range;
        return !invalid;
    }

    public static boolean isValid(Entity entity) {
        PlayerEntity player;
        boolean invalid = entity == null || !entity.isAlive() || entity.equals((Object)CombatUtil.mc.player) || entity instanceof PlayerEntity && Frog.FRIEND.isFriend(player = (PlayerEntity)entity);
        return !invalid;
    }
