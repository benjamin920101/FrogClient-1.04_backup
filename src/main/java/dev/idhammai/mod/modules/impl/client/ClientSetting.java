...
extends Module {
    ...
    // default false so vanilla FPS cap remains enabled
    ...
    public final StringSetting windowTitle = this.add(new StringSetting("WindowTitle", dev.idhammai.Frog.NAME, () -> this.page.is(Page.Misc) && this.titleOverride.isOpen()));
    ...
    public final StringSetting hackName = this.add(new StringSetting("Notification", "[" + dev.idhammai.Frog.NAME + "]", () -> this.page.getValue() == Page.Notification));
