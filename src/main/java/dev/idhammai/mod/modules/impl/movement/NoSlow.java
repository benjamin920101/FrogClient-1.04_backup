            ...
            switch (this.mode.getValue().ordinal()) {
                ...
                case 2: {
                    if (NoSlow.mc.player.getActiveHand() == Hand.OFF_HAND) {
                        NoSlow.sendSequencedPacket(id -> new PlayerInteractItemC2SPacket(Hand.MAIN_HAND, id, Frog.ROTATION.getLastYaw(), Frog.ROTATION.getLastPitch()));
                        break;
                    }
                    NoSlow.sendSequencedPacket(id -> new PlayerInteractItemC2SPacket(Hand.OFF_HAND, id, Frog.ROTATION.getLastYaw(), Frog.ROTATION.getLastPitch()));
                    break;
                }
                case 3: {
