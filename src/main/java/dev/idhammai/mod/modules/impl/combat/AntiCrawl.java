...
extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (this.whileSetting.is(While.Always) && BlockUtil.getBlock(AntiCrawl.mc.player.getBlockPos()) != Blocks.BEDROCK || AntiCrawl.mc.player.isCrawling() || this.whileSetting.is(While.Mining) && Frog.BREAK.isMining(AntiCrawl.mc.player.getBlockPos())) {
