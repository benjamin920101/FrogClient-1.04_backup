...
extends Module {
    ...
    public AutoReconnect() {
        ...
        INSTANCE = this;
        Frog.EVENT_BUS.subscribe(new StaticListener());
    }
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (this.autoQueue.getValue() && !this.queueingByMessage && InventoryUtil.findItem(Items.COMPASS) != -1 && this.queueTimer.passedS(this.joinQueueDelay.getValue())) {
            ...
            AutoReconnect.sendSequencedPacket(id -> new PlayerInteractItemC2SPacket(Hand.MAIN_HAND, id, Frog.ROTATION.getLastYaw(), Frog.ROTATION.getLastPitch()));
