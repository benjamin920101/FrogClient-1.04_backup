...
import dev.idhammai.api.events.impl.TimerEvent;
...
extends Module {
    ...
    public void onEnable() {
        ...
        this.holePos = Frog.HOLE.getHole((float)this.range.getValue(), true, this.any.getValue(), this.up.getValue());
    }
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (Frog.HOLE.isDoubleHole(this.holePos) && (facing = Frog.HOLE.is3Block(this.holePos)) != null) {
